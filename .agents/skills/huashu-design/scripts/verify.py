#!/usr/bin/env python3
"""
verify.py — Playwright wrapper for verifying claude-design HTML output
...
Usage:
    ...
    python verify.py deck.html --slides 10                  # Slide-by-slide screenshots (first 10 slides)
    python verify.py design.html --output ./screenshots/   # Output directory
    python verify.py design.html --show                    # Non-headless, open real browser window
...
def main():
    ...
    parser.add_argument("--slides", type=int, default=0,
                        help="Slide mode: capture first N slides (requires HTML to support ArrowRight navigation)")
