/**
 * DesignCanvas — Variant comparison grid layout
 *
 * For displaying 2+ static design variations for side-by-side comparison.
 * Each variation has a label and supports hover zoom.
 *
 * Usage:
 *   <DesignCanvas
 ...
 *     columns={3}
 *   >
 *     <Variation label="Minimal" description="Restrained minimalist version">
 ...
 *   </DesignCanvas>
 *
 * Use with React + Babel. Place in an appropriate script tag, then window.DesignCanvas/window.Variation is available.
 */
